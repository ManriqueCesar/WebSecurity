    ...
    $.fn.examWizard = function (options) {
        ...
        function getAllAnswerdValue(groupingData = !1, getAlternateAnswerdOnly = !0, fieldName = !1) {
            ...
            for (var i = 0; i < formsValue.length; i++) {
                ...
                var objResult = {
                    'name': formsValue[i].name,
                    'value': formsValue[i].value,
                    'alternateName': tempVal.attr(settings.alternateNameAttr),
                    'alternateValue': tempVal.attr(settings.alternateValueAttr),
